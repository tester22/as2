//$Header: /cvsroot-fuse/mec-as2/b47/de/mendelson/comm/as2/client/ListCellRendererEncryption.java,v 1.1 2015/01/06 11:07:37 heller Exp $
    ...
    public Component getListCellRendererComponent(
        ...
        if (value != null) {
            if (value instanceof Integer) {
                ...
                this.setText(this.rbMessage.getResourceString("encryption." + String.valueOf(value)));
            }
        }
