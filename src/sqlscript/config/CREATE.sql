...
#notification
#
CREATE TABLE notification(id INTEGER IDENTITY PRIMARY KEY,mailhost VARCHAR(255),mailhostport INTEGER,mailaccountname VARCHAR(255),mailaccountpass VARCHAR(255),notificationemailaddress VARCHAR(255),notifycertexpire INTEGER DEFAULT 0 NOT NULL,notifytransactionerror INTEGER DEFAULT 0 NOT NULL,notifycem INTEGER DEFAULT 0 NOT NULL,notifysystemfailure INTEGER DEFAULT 0 NOT NULL,replyto VARCHAR(255),usesmtpauth INTEGER DEFAULT 0 NOT NULL,smtpauthuser VARCHAR(255),smtpauthpass VARCHAR(255),notifyresend INTEGER DEFAULT 0 NOT NULL,security INTEGER DEFAULT 0 NOT NULL)
